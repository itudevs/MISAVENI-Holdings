...
(function () {
	...
	carousels.forEach(function (carousel) {
		...
		var autoHeight = carousel.getAttribute('data-carousel-autoheight') === 'true';
		...
		function goToSlide(targetIndex, directionOverride) {
			...
			setTimeout(function () {
				outgoing.classList.remove('active', 'slide-out-left', 'slide-out-right');
				outgoing.setAttribute('aria-hidden', 'true');

				incoming.classList.remove(enterClass, 'position-left', 'position-right');
